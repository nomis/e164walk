...
# encoding: utf-8
#
#	e164dnshide - hides empty terminals in an e164.arpa zone (preventing walking)
#
...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description='Hides empty terminals in an e164.arpa zone (preventing walking)')
